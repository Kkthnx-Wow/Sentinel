...
L["Sending %d of %d session errors (message size limit)."] = "Sending %d of %d session errors (message size limit)."
...
L["this session"] = "this session"
L["paused (flood protection)"] = "paused (flood protection)"
L["Capture paused: too many errors per second (automatic)."] = "Capture paused: too many errors per second (automatic)."
L["Usage: /sen [help|status|config|clear|pause|resume|sound|chat|taintlog|test|build]"] = "Usage: /sen [help|status|config|clear|pause|resume|sound|chat|taintlog|test|build]"
...
L["/sen taintlog - cycle Blizzard taintLog level (0-4)."] = "/sen taintlog - cycle Blizzard taintLog level (0-4)."
...
-- Blizzard taintLog CVar (12.0+)
L["TaintLog: Off"] = "TaintLog: Off"
L["TaintLog: %d"] = "TaintLog: %d"
L["TaintLog level 0"] = "Off"
L["TaintLog level 1"] = "Blocked actions"
L["TaintLog level 2"] = "Global taint"
L["TaintLog level 3"] = "Upvalue taint"
L["TaintLog level 4"] = "Table field taint"
L["Taint log is now off."] = "Taint log is now off."
L["Taint log level set to %d (%s). Output: taint.log"] = "Taint log level set to %d (%s). Output: taint.log"
L["TaintLog button tooltip"] = "Cycles Blizzard's taintLog level (left-click). Debug output is written to taint.log in your World of Warcraft folder.\n\n0: Off\n1: Blocked actions and leading taint events\n2: Tainted global variable reads/writes\n3: Tainted upvalue reads/writes\n4: Tainted table field reads/writes"
L["Taint log"] = "Taint log"
L["Taint log is not available on this client."] = "Taint log is not available on this client."

-- New in 1.5.5
L["Sharing is unavailable (missing libraries). Use Export instead."] = "Sharing is unavailable (missing libraries). Use Export instead."
L["Generating a test error..."] = "Generating a test error..."
L["This cannot be undone."] = "This cannot be undone."
L["Unsupported error report version. Ask the sender to update Sentinel."] = "Unsupported error report version. Ask the sender to update Sentinel."
L["Too many error reports from %s. Further reports ignored for now."] = "Too many error reports from %s. Further reports ignored for now."
L["Cycle Blizzard taintLog level (0-4). Output is written to taint.log."] = "Cycle Blizzard taintLog level (0-4). Output is written to taint.log."
